...
function email_duplication_check() {
    ...
    $.ajax({
        url: "http://43.202.162.17:8080/api/v1/members/email-check?email=" + email.val(),
        type: "GET",
        success: function() {
...
document.addEventListener("DOMContentLoaded", function() {
    if (window.localStorage.getItem('X-SELAB-AUTH-TOKEN') != null) {
        ...
        location.href = "http://43.202.162.17:8080/home";
        return;
    }
...
function sign_up_submit() {
    if(email_duplication_boolean && password_boolean && password_check_boolean
        ...
        $.ajax({
            url: "http://43.202.162.17:8080/api/v1/members/signup",
            data: data,
